...
uint8_t measure_circular_list_head_performance() {
	...
	// GCC -O3 -mcpu=cortex-m4 -mthumb (Translation Unit Boundary): cold cycles = 15218 | warm cycles = 15096-15098
	...
	// GCC -O3 -mcpu=cortex-m4 -mthumb -flto: cold cycles = 5576 | warm cycles = 5472
	start = DWT->CYCCNT;
