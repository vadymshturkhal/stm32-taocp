...
void asm_inverse_permutation_in_place(int32_t *permutation, uint32_t permutation_length);
...
//	uint32_t permutation[] = {0, 16, 14, 13, 1, 15, 9, 12, 8, 6, 2, 11, 10, 4, 3, 7, 5};
	...
	// cycles_cold = [181-189], cycles_warm = 167, size = 100 bytes;
	start = DWT->CYCCNT;
	...
	// cycles_cold = [150-151], cycles_warm = 139, size = 50 bytes;
	start = DWT->CYCCNT;
