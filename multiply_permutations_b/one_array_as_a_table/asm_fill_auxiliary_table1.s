.syntax unified
    .thumb
    .cpu cortex-m4
    .global asm_fill_auxiliary_table1
...
permutation_loop:
    ...
    CMP R7, #26
    BHS handle_parentheses	@ Cold Path for parentheses

    LDRSB R12, [R2, R7]		@ auxiliary_table[element_index];
    CMP R12, #-1
    ITT EQ
    MOVEQ R12, R5			@ R12 = current_element;
